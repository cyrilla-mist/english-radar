...
assert.equal(content.getActiveLearningSignals().length, 66);
assert.equal(registry.getStaticQuizzes().length, 220);
...
assert.equal(content.getActiveLearningSignals().length, 76);
...
assert.equal(content.getActiveLearningSignals().length, 100);
...
content.invalidate();
assert.equal(content.getActiveLearningSignals().length, 90);
