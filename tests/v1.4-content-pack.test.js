...
assert.equal(content.getActiveLearningSignals().length, 68);
assert.equal(registry.getStaticQuizzes().length, 224);
...
assert.equal(content.getActiveLearningSignals().length, 78);
...
assert.equal(content.getActiveLearningSignals().length, 102);
...
content.invalidate();
assert.equal(content.getActiveLearningSignals().length, 92);
