...
assert.match(archive, /Internet Context Archive/);
assert.match(archive, /互联网语境档案/);
assert.match(archive, /Signals, context, and usage—kept for reference\./);
assert.match(archive, /收集并留存真实互联网语境中的表达、含义与使用边界。/);
