...
assert.match(notFound, /<meta name="version" content="v1\.8\.2">/i);
assert.match(notFound, /<meta name="description" content="English Radar v1\.8\.2 signal not found\.">/i);
