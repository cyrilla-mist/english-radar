...
assert.match(notFound, /<meta name="version" content="v1\.8\.3">/i);
assert.match(notFound, /<meta name="description" content="English Radar v1\.8\.3 signal not found\.">/i);
