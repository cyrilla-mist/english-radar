(function () {
  ...
  function validFullForm(value) { return value === undefined || (typeof value === 'string' && value.trim()); }
  ...
  function normalizeSignal(raw, context) {
    ...
    if (typeof raw.fullForm === 'string') result.fullForm = raw.fullForm.trim();
