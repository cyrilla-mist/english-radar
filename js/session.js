(function () {
  ...
  function translateProfile(value, map) { return String(value || '').split(/\s+(?:路|·)\s+/).map(function (item) { return map[item] || item; }).join(' · '); }
