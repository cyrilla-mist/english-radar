(function () {
  ...
  function renderSignal() {
    ...
    setText(refs.term, learnDisplayTerm); setText(refs.pronunciation, signal.pronunciation); setTemplateMode(signal); if (interfaceMode) renderInterfaceSignal(signal); else renderStandardSignal(signal);
