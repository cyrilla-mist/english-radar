(function () {
  ...
  var coreQuizzes = clean(core); var contentPack01Quizzes = clean(contentPack01); var contentPack02Quizzes = clean(contentPack02); var interfaceQuizzes = clean(ui.concat(contentPack01Quizzes.filter(function (question) { return /^ui-/.test(question.signalId); }))); var staticQuizzes = clean(coreQuizzes.concat(interfaceQuizzes, contentPack01Quizzes, contentPack02Quizzes));
