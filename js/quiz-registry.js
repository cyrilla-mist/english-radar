(function () {
  ...
  var contentPack04 = Array.isArray(window.ENGLISH_RADAR_CONTENT_PACK_04_QUIZZES) ? window.ENGLISH_RADAR_CONTENT_PACK_04_QUIZZES : [];
  ...
  var coreQuizzes = clean(core); var contentPack01Quizzes = clean(contentPack01); var contentPack02Quizzes = clean(contentPack02); var contentPack03Quizzes = clean(contentPack03); var contentPack04Quizzes = clean(contentPack04); var interfaceQuizzes = clean(ui.concat(contentPack01Quizzes.filter(function (question) { return /^ui-/.test(question.signalId); }), contentPack03Quizzes)); var staticQuizzes = clean(coreQuizzes.concat(interfaceQuizzes, contentPack01Quizzes, contentPack02Quizzes, contentPack03Quizzes, contentPack04Quizzes));
  window.EnglishRadarQuizRegistry = {
    ...
    getContentPack04Quizzes: function () { return contentPack04Quizzes.slice(); },
